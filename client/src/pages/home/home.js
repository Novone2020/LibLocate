...
export const Home = () => {
  const [account, ] = useState("novone2020");
  ...
  const autoFetch = () => {
    axios
      .get("https://liblocate-server.onrender.com/pict0/getPost")
      .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post("https://liblocate-server.onrender.com/pict0/createPost", {
        ...postData,
        account,
      })
      .then((res) => {
      ...
      <div className="home-share-area">
        ...
        <form className="form-adjust form-control" onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="post-title home-inputs"
            onChange={(e) =>
          ...
          <textarea
            ...
            className="post-description home-inputs"
            onChange={(e) =>
